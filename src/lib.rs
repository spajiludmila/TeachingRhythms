// src/lib.rs
/*
 * Core library for TeachingRhythms
 */
...
#[derive(Debug)]
pub struct TeachingRhythmsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TeachingRhythmsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TeachingRhythms processing");
    
    let mut processor = TeachingRhythmsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TeachingRhythmsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TeachingRhythmsProcessor::new(false);
